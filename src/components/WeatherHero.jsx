        ...
        <div className="lg:col-span-8 bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-200 relative overflow-hidden">
          ...
          <div className="mt-6 pt-4 border-t border-slate-100 flex flex-wrap items-center justify-between gap-3">
            ...
            {current.alertTriggerType && (
              <div className="flex items-center gap-2 px-3.5 py-2 rounded-2xl text-xs font-black bg-rose-50 text-rose-800 border border-rose-200 shadow-sm">
                <span className="relative flex h-2 w-2 shrink-0">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-rose-400 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-rose-500"></span>
                </span>
                <span>🚨 {currentLang === 'te' ? 'భారీ వాతావరణ ముప్పు గుర్తించబడింది: ఆటోమేటిక్ అలర్ట్ సిద్ధంగా ఉంది' : 'Heavy Weather Risk: Automated Sentinel Active'}</span>
              </div>
            )}
          </div>
